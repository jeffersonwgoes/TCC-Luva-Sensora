...
// Pin definition
#define LCD16X2_PIN_RS  RS_Pin
#define LCD16X2_PIN_RW  RW_Pin
#define LCD16X2_PIN_EN  EN_Pin
#define LCD16X2_PIN_D4  D4_Pin          // 4-bit mode LSB
#define LCD16X2_PIN_D5  D5_Pin
#define LCD16X2_PIN_D6  D6_Pin
#define LCD16X2_PIN_D7  D7_Pin          // 4-bit mode MSB
...
#define lcdInit(args)               lcd16x2_init(args)
#define lcdGoto(x, y)               lcd16x2_gotoxy(x, y)
#define lcdPrint(string)            lcd16x2_puts(string)
#ifdef __cplusplus
}
#endif
